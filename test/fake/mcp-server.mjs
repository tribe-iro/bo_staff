...
rl.on("line", (line) => {
  ...
  switch (message.method) {
    ...
    case "tools/list":
      respond(message.id, {
        tools: [
          ...
          {
            name: "other_tool",
            description: "Return a second marker.",
            inputSchema: {
              type: "object",
              properties: {},
              additionalProperties: false
    ...
    case "tools/call":
      ...
      if (message.params?.name === "other_tool") {
        respond(message.id, { content: [{ type: "text", text: "OTHER-OK" }], isError: false });
        return;
      }
